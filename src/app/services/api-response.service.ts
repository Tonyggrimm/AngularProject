//SERVICE THAT GETS AND HANDLES DATA FOR THE CAROUSSEL
...
export class ApiResponseService {
    ...
    getImages(): Observable<ImageResponse[]> {
        return (this.http.get<BasicResponse[]>(`${this.baseUrl}`)).pipe(
                    map((imagesResponse)=>this.photomapperservice.toClient(imagesResponse)));
    }
